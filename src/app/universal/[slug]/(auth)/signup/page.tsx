            ...
            <div style={{ maxWidth: '400px', width: '100%', padding: '2rem', border: '1px solid rgba(128,128,128,0.2)', borderRadius: '12px', background: 'rgba(255,255,255,0.05)' }}>
                ...
                <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div style={{ display: 'flex', gap: '1rem' }}>
                        <input type="text" placeholder="First Name" style={{ width: '100%', padding: '0.8rem', borderRadius: '6px', border: '1px solid #ccc', background: 'transparent', color: 'inherit' }} />
                        <input type="text" placeholder="Last Name" style={{ width: '100%', padding: '0.8rem', borderRadius: '6px', border: '1px solid #ccc', background: 'transparent', color: 'inherit' }} />
                    </div>
                    <input
                        type="email"
                        placeholder="Email"
                ...
                <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.9rem' }}>
                    Already have an account? <Link href={`/universal/${slug}/login`} style={{ textDecoration: 'underline' }}>Sign In</Link>
                </div>
            </div>
        </div>
    );
